...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def load_model(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        self.openfile_name_model, _ = QFileDialog.getOpenFileName(self.button_weight_select, 'trained/',
                                                                  'weights/', "best.pt", options=options)
    ...
    def init_icons(self):
        ...
        self.label_main.setPixmap(QPixmap("bg1.jpg"))
...
if __name__ == "__main__":
    ...
    window = MainWindow()
    window.setWindowTitle('基于YOLO的空中视角车辆检测系统')
